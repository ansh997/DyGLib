...
#SBATCH --output=/home2/hmnshpl/projects/results/DygLib/wiki_LP_model_save.txt
...
python train_link_prediction.py --dataset_name wikipedia --model_name JODIE --load_best_configs --num_runs 5 --gpu 0
python train_link_prediction.py --dataset_name wikipedia --model_name TGAT --load_best_configs --num_runs 5 --gpu 0
