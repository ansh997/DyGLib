...
#SBATCH --output=/home2/hmnshpl/projects/results/DygLib/Link_Prediciton_inc_ts_tpr_test_run_0.8.txt
...
python train_link_prediction.py --dataset_name wikipedia --model_name TGN --patch_size 2 --max_input_sequence_length 64 --num_runs 5 --gpu 0 --sparsify True --strategy ts_tpr_remove_inc --sampling_upto 0.8
